package com.fabricadesoftware.financas.api.exceptionHandler;
...
public class financasExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleEmptyResultDataAccessException(DataIntegrityViolationException ex, WebRequest request){
        ...
        String mensagemUsuario = messageSource.getMessage("recurso.opracao-nao-permitida", null, LocaleContextHolder.getLocale());
