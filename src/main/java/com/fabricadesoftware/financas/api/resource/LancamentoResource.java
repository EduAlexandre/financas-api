...
import com.fabricadesoftware.financas.api.exceptionHandler.financasExceptionHandler;
...
import com.fabricadesoftware.financas.api.service.LancamentoService;
...
public class LancamentoResource {
    ...
    public ResponseEntity<Object> handlePessoaInexistenteOuInativaException(PessoaInexistenteOuInativaException ex){
        ...
        List<financasExceptionHandler.Erro> erros = Arrays.asList(new financasExceptionHandler.Erro(mensagemUsuario, mensagemDesenvolvedor));
